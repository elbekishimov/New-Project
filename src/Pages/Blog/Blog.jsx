          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <div className="flex gap-4 pt-2">
                <Link
                  to="/call-us"
                  className="bg-sky-500 hover:bg-sky-600 text-white px-8 py-3 rounded-lg font-semibold transition inline-block"
                >
                  Call Us
                </Link>
                <Link to={'/leave-mesage'} className="bg-emerald-900 hover:bg-emerald-800 text-white px-8 py-3 rounded-lg font-semibold transition">
                  Leave a Message
                </Link>
              </div>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-12 py-16">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <Link to={'/contact-us'} className="bg-emerald-900 hover:bg-emerald-800 text-white px-10 py-3 rounded-lg font-semibold transition shadow-lg">
                Contact us
              </Link>
            </div>
